# Spec: Fix CLI Build Execution, Add Dist/Npx/Docker Smoke Tests & Realign Local/Remote Docs
...
- 2026-09-24: Initial spec created for CLI module resolution fix, smoke tests, CI Docker entrypoint analysis, and documentation alignment.
