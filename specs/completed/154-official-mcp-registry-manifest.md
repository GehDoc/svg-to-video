...
- **Release Automation**: Download `mcp-publisher` CLI tool, authenticate via `github-oidc`, and publish `mcp.json` in `.github/workflows/release.yml` executing after Docker image publication.
...
- [x] **MCP Manifest & Action**
  ...
  - [x] Update `.github/workflows/release.yml` to download `mcp-publisher`, authenticate via OIDC, and publish `mcp.json`
- [x] **Documentation & SEO**
