...
| :------------------- | :-------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `file-load`          | User loads an SVG via file browser or drag-and-drop | `method` (`file-picker` \| `drag-and-drop`), `aspectRatio` (`square` \| `landscape` \| `portrait` \| `unknown`), `hasAnimation`, `detectedDuration`, `isDimensionsDetected` |
