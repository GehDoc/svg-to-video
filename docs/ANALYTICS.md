...
| :------------------- | :------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------- |
| `file-load`          | Instant trigger when user ingests an SVG via file picker or drag-and-drop | `method` (`file-picker` \| `drag-and-drop`)                                                                                    |
| `file-parsed`        | Fires when SVG analysis completes in Web Studio state                     | `aspectRatio` (`square` \| `landscape` \| `portrait` \| `unknown`), `hasAnimation`, `detectedDuration`, `isDimensionsDetected` |
